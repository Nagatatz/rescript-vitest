...
- [x] docs-only コミットを作成（4006cd0。2026-08-30 に事後記録）

## 完了条件

- [x] すべてのタスクが完了していること
- [x] CLAUDE.md の @import 対象 rule ファイルがすべて存在すること
- [x] rules 合計が約 450 行以下になっていること（2026-08-30 実測 479 行。許容範囲として完了扱い）
- [x] 規約の意味内容が失われていないこと（手順は skill から参照可能）
